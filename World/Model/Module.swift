...
enum Module: String, Identifiable, CaseIterable, Equatable {
    case globe, orbit, solar, aboutme
    var id: Self { self }
    ...
    var eyebrow: String {
        ...
        // add aboutme
        case .aboutme:
            String(localized: "About The Author", comment: "The subtitile of the About Me module.")
        }
    }
    ...
    var heading: String {
        ...
        // add aboutme
        case .aboutme:
            String(localized: "About Me", comment: "Thr title of a module in the app.")
        }
    }
    ...
    var abstract: String {
        ...
        // add aboutme
        case .aboutme:
            String(localized: "This is my brief self-introduction, including my educational background, work experience as well as my interests and hobbies.", comment: "Detail text explaining the About Me module.")
        }
    }
    ...
    var overview: String {
        ...
        // add aboutme
        case .aboutme:
            String(localized: "My name is QIU Penghao, and I come from Changchun, Jilin, located in the Northeast of China. Education background in 2019, I entered High School Attached to Northeast Normal University. I entered Tongji University in 2022, and now I major in software engineering with the great interest in computer science and technology. When it comes to my leisure time, my greatest hobby is almost all kinds of sports, especially basketball and badminton.\n\nDue to time constraints, there is no time for me to record a self-introduction video. So I find a sample video to play here. So sorry about this.", comment: "Educational text displayed in the AboutMe module.")
        }
    }
    ...
    var callToAction: String {
        ...
        // add aboutme
        case .aboutme: String(localized: "View AboutMe Video", comment: "An action the viewer can take in the About Me module.")
        }
    }

    static let funFacts = [
        // all in outer space flash
        ...
        // add aboutme
        // String(localized: "", comment: "An educational fact displayed in the AboutMe module.")
    ]
}
